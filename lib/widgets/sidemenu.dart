...
class SideMenuState extends State<SideMenu> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _listTileWithIconAndCounter(
              LineIcons.checkCircle, 'Tasks', 9, colorPrimary, colorLight),
          _listTileWithIconAndCounter(
              LineIcons.listUl, 'Activities', 32, colorAlert, colorLight),
          const Padding(
  ...
  Widget _listTileWithIconAndCounter(IconData icon, String title, int counter,
  ...
  Widget _projectsList() {
    return Column(
      ...
      children: [
        ...
        _listTileWithIconAndCounter(
            LineIcons.circle, 'Google Ads', 9, colorGray60, colorGray80),
        _listTileWithIconAndCounter(
            LineIcons.circle, 'WayFinder', 3, colorGray60, colorGray80),
        _listTileWithIconAndCounter(
            LineIcons.circle, 'Internal Test', 12, colorGray60, colorGray80),
        const SizedBox(
          height: 20.0,
        ),
        Padding(
